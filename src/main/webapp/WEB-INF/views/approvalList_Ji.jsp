	...
	<div id="wrapper">
		<div id="main">
			<div class="inner">
				...
				<%-- <c:if test="${paper eq '지출결의서'}"> --%> <!-- 나중에 결재안 리스트들 합쳐야 할 때 사용 -->
						...
						<tr class="actions">
							<td colspan="4" align="right">
								<input class="button big" type="button" value="글쓰기"
									onclick="location.href='approvalInsert?paper=<%=paper%>&currentPage=${elecapprsawonList.currentPage}'">
							</td>
						</tr>
					</table>
				<%-- </c:if> --%>
