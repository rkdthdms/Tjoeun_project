...
public class BoardList {
	...
	private ArrayList<BoardVO> list2 = new ArrayList<BoardVO>();
	...
	public ArrayList<BoardVO> getList2() {
		return list2;
	}
	public void setList2(ArrayList<BoardVO> list2) {
		this.list2 = list2;
	}
	...
	public String toString() {
		return "BoardList [list2=" + list2 + ", pageSize=" + pageSize + ", totalCount=" + totalCount + 
